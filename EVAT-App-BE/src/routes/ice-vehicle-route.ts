...
import IceVehicleController from "../controllers/ice-vehicle-controller";
import IceVehicleService from "../services/ice-vehicle-service";

const router = Router();
const iceVehicleService = new IceVehicleService();
const iceVehicleController = new IceVehicleController(iceVehicleService);
...
router.get("/:vehicleId", authGuard(["user", "admin"]), (req, res) =>
  iceVehicleController.getVehicleById(req, res)
);
...
router.get("/", authGuard(["user", "admin"]), (req, res) =>
  iceVehicleController.getAllVehicles(req, res)
);
